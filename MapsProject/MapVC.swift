...
//  MapsProject
//
//  Created by LianaKryu on 23.11.2020.
//
...
var pointsArray = [Points]()
    ...
    override func viewDidLoad() {
        ...
        mapView.userLocation.subtitle = "You find me"
        // Do any additional setup after loading the view.
    }
    func mapView(_ mupView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
